...
<body><!-- Start: Navbar Centered Links -->
  ...
  <section class="py-5">
    <div class="container text-center py-5"><!-- Start: Lightbox Gallery No Gutters -->
      <section class="py-4 py-xl-5">
        <div class="container-fluid p-0">
          ...
          ?>
          <!-- Start: Photos -->
          <div class="row g-0 row-cols-2 row-cols-md-2 row-cols-xl-3 d-flex d-xl-flex justify-content-start align-items-start justify-content-xl-center align-items-xl-center" data-bss-baguettebox="">
            <div class="col-xl-6" id="map" style="width: 500px; height: 500px;">
            ...
            if (scientificName) {
              ...
              $.getJSON(apiUrl, function(data) {
                ...
                if (total == 0) {
                  ...
                  var items = [];
                  items.push('<h4 class="card-title">FamilyName1: ' + record.FamilyName1 + '</h4>');
                  items.push('<h6 class="text-muted card-subtitle mb-2">CommonName: ' + record.CommonName + '</h6>');
                  items.push('<h6 class="text-muted card-subtitle mb-2">ScientificName: ' + record.ScientificName + '</h6>');
