      ...
      <div class="row py-5">
        <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-end mb-4">
          <div style="max-width: 450px;">
            <p class="fw-bold text-success mb-2">Search species</p>
            <h2 class="fw-bold">We will do our best to search for the fish species you are looking for.</h2>
            <form id="searchForm" class="d-flex justify-content-center flex-wrap justify-content-md-start flex-lg-nowrap">
              <div class="my-2 me-2"><input class="border rounded-pill shadow-sm form-control" type="text" id="searchInput" placeholder="Tap keyword to search"></div>
              <div class="my-2"><button class="btn btn-primary shadow" type="submit">Search</button></div>
            </form>
          </div>
        </div>
        ...
        <div class="col-md-6 mb-4" style="width: 560px; height:680px;" id="map">
        ...
        <div class="col">
          <div data-bss-hover-animate="shake" id="output">
        </div>
        </div>
      </div>
      <div class="col">
        <form id="suggestionForm">
          <p class="fw-bold text-success mb-2">Suggestion</p>
          <button class="btn btn-primary shadow" type="submit">Suggest 5 species</button>
        </form>
        <div id="suggestionOutput" data-bss-hover-animate="shake">
        </div>
      </div>
      <div class="col mb-4">
    ...
    $('#searchForm').on('submit', function(e) {
      ...
      $.getJSON(apiUrl, function(data) {
        ...
        if (total == 0) {
          ...
          var items = [];
          items.push("<thead><tr><th scope='col'>FamilyName</th><th scope='col'>CommonName</th><th scope='col'>scientificName</th><th scope='col'>Details</th></tr></thead>");
          $.each(data.result.records, function(key, val) {
            items.push('<tbody><tr><th>' + val.FamilyName1 + '</th><th>' + val.CommonName + '</th><th>' + val.ScientificName + '</th><th> <a href="detail.php?scientificName=' + val.ScientificName + '">More Details</a></th></tr></tbody>');
          });
          $('<table/>', {
