...
if (isset($_POST['email'])) {
  if ($_POST['email'] != '' && $_POST['password'] != '') {
    ...
    echo "<h1 style='background:red'>You can't leave anything empty!</h1>";
  }
}
        ...
        <div class="col-md-6 col-xl-4">
          <div class="card">
            <div class="card-body text-center d-flex flex-column align-items-center"
              style="border-radius: 47px;border-style: dashed;border-color: var(--bs-blue);">
              <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4"><img class="rounded-circle"
                  src="./assets/img/clipboard-image.png?h=c9e81f284e31d65d9aac008a4544c6ab" width="114" height="101">
              </div>
              <form method="post">
                <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Email"></div><input
                  class="form-control" type="text" name="username" placeholder="username" style="margin-bottom: 13px;">
                <div class="mb-3"><input class="form-control" type="password" name="password" placeholder="Password">
                </div>
                <div class="mb-3"></div>
                <p class="text-muted"><button class="btn btn-primary shadow d-block w-100" type="submit">Sign
                    up</button>Already have an account?&nbsp;<a href="./login.php">Log in</a></p>
              </form>
            </div>
            <div class="card-body text-center d-flex flex-column align-items-center">
              <form method="post">
